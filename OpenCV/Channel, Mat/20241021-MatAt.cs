...
namespace _20241021_MatAt01
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("[m1] = "); Console.WriteLine(m1.Dump());
            Console.WriteLine("[m2] = "); Console.WriteLine(m2.Dump());
            Console.WriteLine("[m3] = "); Console.WriteLine(m3.Dump());
            Console.WriteLine("[m4] = "); Console.WriteLine(m4.Dump());
        }
    }
}
